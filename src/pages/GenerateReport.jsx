...
const GenerateReport = () => {
    ...
    const fetchReportData = async () => {
        try {
            const response = await axios.get(`${backendUrl}/api/generate-report`, {
                params: {
    ...
    const handleExportPDF = async () => {
        try {
            const response = await axios.get(`${backendUrl}/api/export-pdf`, {
                responseType: 'blob',
    ...
    const handleExportExcel = async () => {
        try {
            const response = await axios.get(`${backendUrl}/api/export-excel`, {
                responseType: 'blob',
                params: { start_date: startDate, end_date: endDate, report_type: reportType },
            });
