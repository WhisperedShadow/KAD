...
const CompanyCode = () => {
    ...
    const fetchCompanyCodes = async () => {
        try {
            const response = await axios.get('http://localhost:5000/api/companycode');
    ...
    const handleCreate = async () => {
        try {
            if (editId) {
                await axios.put(`http://localhost:5000/api/companycode/${editId}`, {
                    companyName,
                    shortName,
                    comments,
                });
            } else {
                await axios.post('http://localhost:5000/api/companycode', {
                    companyName,
                    shortName,
                    comments,
                });
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://localhost:5000/api/companycode/${id}`);
            fetchCompanyCodes();
        } catch (error) {
